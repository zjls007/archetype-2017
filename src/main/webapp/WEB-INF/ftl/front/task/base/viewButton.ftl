...
<button class="layui-btn layui-btn-sm" type="reset" onclick="javascript:parent.newTab('${modelNameCN!}查看', '${basePath}/front/task/complete/task/${(entity.id)!}')"><i class="layui-icon">&#xe616;</i>完成</button>
</#if>
<#if false>
<script>
</#if>
