...
public class SelectUtil {
    ...
    static {
        selectMap.put("task.difficult", TaskDifficult.getSelectList());
        selectMap.put("task.state", TaskState.getSelectList());
        selectMap.put("task.type", TaskType.getSelectList());
    }
