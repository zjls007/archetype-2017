...
public class RSAUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String text = "世界和平";
        String sign = sign(text, privateKey, charset);
        System.out.println(sign);

        boolean result = verify(text, sign, publicKey, charset);
        System.out.println(result);

        String en = Base64.encodeBase64String(encryptByPublicKey(text.getBytes(), publicKey));
        System.out.println(en);

        System.out.println(new String(decryptByPrivateKey(Base64.decodeBase64(en), privateKey)));
